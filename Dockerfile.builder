...
FROM docker.io/library/ubuntu:20.04@sha256:80ef4a44043dec4490506e6cc4289eeda2d106a70148b74b5ae91ee670e9c35d as base
...
RUN apt-get update && \
	...
	python3 python-is-python3 unzip virtualenv wget zip xz-utils \
