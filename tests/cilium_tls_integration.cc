...
Network::TransportSocketFactoryPtr createClientSslTransportSocketFactory(
    Ssl::ContextManager& context_manager, Api::Api& api) {
  ...
  TestUtility::loadFromYaml(TestEnvironment::substitute(yaml_plain),
                            tls_context);
