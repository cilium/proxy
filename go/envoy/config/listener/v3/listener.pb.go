...
const file_envoy_config_listener_v3_listener_proto_rawDesc = "" +
	...
	"\aentries\x18\x01 \x03(\v2\x1c.xds.core.v3.CollectionEntryR\aentries\"\xbe\x18\n" +
	"\bListener\x12\x12\n" +
	...
	"statPrefix\x12J\n" +
	"\rfilter_chains\x18\x03 \x03(\v2%.envoy.config.listener.v3.FilterChainR\ffilterChains\x12X\n" +
