...
const file_envoy_config_metrics_v3_stats_proto_rawDesc = "" +
	...
	"\x05match\x18\x01 \x01(\v2$.envoy.type.matcher.v3.StringMatcherB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x05match\x121\n" +
	"\abuckets\x18\x02 \x03(\x01B\x17\xfaB\x14\x92\x01\x11\b\x01\x18\x01\"\v\x12\t!\x00\x00\x00\x00\x00\x00\x00\x00R\abuckets\"\xcf\x01\n" +
	"\n" +
	"StatsdSink\x129\n" +
