...
const file_envoy_config_accesslog_v3_accesslog_proto_rawDesc = "" +
	...
	"\x10filter_specifier\x12\x03\xf8B\x01\"\xf9\x01\n" +
	...
	"\x05value\x18\x02 \x01(\v2#.envoy.config.core.v3.RuntimeUInt32B\b\xfaB\x05\x8a\x01\x02\x10\x01R\x05value\"\x1c\n" +
	"\x02Op\x12\x06\n" +
	"\x02EQ\x10\x00\x12\x06\n" +
	"\x02GE\x10\x01\x12\x06\n" +
	"\x02LE\x10\x02:8\x9aň\x1e3\n" +
