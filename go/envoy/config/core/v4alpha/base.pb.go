...
var file_envoy_config_core_v4alpha_base_proto_depIdxs = []int32{
	...
	23, // 7: envoy.config.core.v4alpha.Metadata.filter_metadata:type_name -> envoy.config.core.v4alpha.Metadata.FilterMetadataEntry
	26, // 8: envoy.config.core.v4alpha.RuntimePercent.default_value:type_name -> envoy.type.v3.Percent
	27, // 9: envoy.config.core.v4alpha.RuntimeFeatureFlag.default_value:type_name -> google.protobuf.BoolValue
	12, // 10: envoy.config.core.v4alpha.HeaderValueOption.header:type_name -> envoy.config.core.v4alpha.HeaderValue
	27, // 11: envoy.config.core.v4alpha.HeaderValueOption.append:type_name -> google.protobuf.BoolValue
	12, // 12: envoy.config.core.v4alpha.HeaderMap.headers:type_name -> envoy.config.core.v4alpha.HeaderValue
	28, // 13: envoy.config.core.v4alpha.RetryPolicy.retry_back_off:type_name -> envoy.config.core.v4alpha.BackoffStrategy
	29, // 14: envoy.config.core.v4alpha.RetryPolicy.max_retries:type_name -> google.protobuf.UInt32Value
	30, // 15: envoy.config.core.v4alpha.RemoteDataSource.http_uri:type_name -> envoy.config.core.v4alpha.HttpUri
	17, // 16: envoy.config.core.v4alpha.RemoteDataSource.retry_policy:type_name -> envoy.config.core.v4alpha.RetryPolicy
	16, // 17: envoy.config.core.v4alpha.AsyncDataSource.local:type_name -> envoy.config.core.v4alpha.DataSource
	18, // 18: envoy.config.core.v4alpha.AsyncDataSource.remote:type_name -> envoy.config.core.v4alpha.RemoteDataSource
	31, // 19: envoy.config.core.v4alpha.TransportSocket.typed_config:type_name -> google.protobuf.Any
	32, // 20: envoy.config.core.v4alpha.RuntimeFractionalPercent.default_value:type_name -> envoy.type.v3.FractionalPercent
	25, // 21: envoy.config.core.v4alpha.Metadata.FilterMetadataEntry.value:type_name -> google.protobuf.Struct
