...
const file_envoy_config_trace_v3_opentelemetry_proto_rawDesc = "" +
	"\n" +
	")envoy/config/trace/v3/opentelemetry.proto\x12\x15envoy.config.trace.v3\x1a$envoy/config/core/v3/extension.proto\x1a'envoy/config/core/v3/grpc_service.proto\x1a'envoy/config/core/v3/http_service.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\"\x93\x03\n" +
	...
	"\asampler\x18\x05 \x01(\v2*.envoy.config.core.v3.TypedExtensionConfigR\asamplerB\x89\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
