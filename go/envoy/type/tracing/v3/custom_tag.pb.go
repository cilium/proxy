...
const file_envoy_type_tracing_v3_custom_tag_proto_rawDesc = "" +
	"\n" +
	"&envoy/type/tracing/v3/custom_tag.proto\x12\x15envoy.type.tracing.v3\x1a%envoy/type/metadata/v3/metadata.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"\xd4\a\n" +
	"\tCustomTag\x12\x19\n" +
	...
	"\bmetadata\x18\x05 \x01(\v2).envoy.type.tracing.v3.CustomTag.MetadataH\x00R\bmetadata\x1aX\n" +
	"\aLiteral\x12\x1d\n" +
