...
const file_envoy_extensions_network_dns_resolver_getaddrinfo_v3_getaddrinfo_dns_resolver_proto_rawDesc = "" +
	"\n" +
	"Senvoy/extensions/network/dns_resolver/getaddrinfo/v3/getaddrinfo_dns_resolver.proto\x124envoy.extensions.network.dns_resolver.getaddrinfo.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dudpa/annotations/status.proto\"]\n" +
	"\x1cGetAddrInfoDnsResolverConfig\x12=\n" +
	"\vnum_retries\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueR\n" +
	"numRetriesB\xd6\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
