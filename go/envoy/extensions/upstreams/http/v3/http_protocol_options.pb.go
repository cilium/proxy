...
const file_envoy_extensions_upstreams_http_v3_http_protocol_options_proto_rawDesc = "" +
	"\n" +
	">envoy/extensions/upstreams/http/v3/http_protocol_options.proto\x12\"envoy.extensions.upstreams.http.v3\x1a$envoy/config/core/v3/extension.proto\x1a#envoy/config/core/v3/protocol.proto\x1aYenvoy/extensions/filters/network/http_connection_manager/v3/http_connection_manager.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xc2\x0f\n" +
	...
	"\x18header_validation_config\x18\a \x01(\v2*.envoy.config.core.v3.TypedExtensionConfigR\x16headerValidationConfig\x1a\xd6\x02\n" +
	...
	"!alternate_protocols_cache_options\x18\x04 \x01(\v24.envoy.config.core.v3.AlternateProtocolsCacheOptionsR\x1ealternateProtocolsCacheOptionsB \n" +
