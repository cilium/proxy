...
import (
	...
	v33 "github.com/cilium/proxy/go/envoy/config/common/mutation_rules/v3"
...
const file_envoy_extensions_filters_http_ext_authz_v3_ext_authz_proto_rawDesc = "" +
	...
	"\x17emit_filter_state_stats\x18\x1d \x01(\bR\x14emitFilterStateStats:5\x9aň\x1e0\n" +
	...
	"4envoy.config.filter.http.ext_authz.v2.BufferSettings\"\xaf\x03\n" +
	"\vHttpService\x12<\n" +
	"\n" +
	...
	"\x16authorization_response\x18\b \x01(\v2A.envoy.extensions.filters.http.ext_authz.v3.AuthorizationResponseR\x15authorizationResponse:8\x9aň\x1e3\n" +
	...
	"\boverride\x12\x03\xf8B\x01\"\xc8\x03\n" +
	...
	"\x11with_request_body\x18\x03 \x01(\v2:.envoy.extensions.filters.http.ext_authz.v3.BufferSettingsR\x0fwithRequestBody\x1aD\n" +
	"\x16ContextExtensionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01::\x9aň\x1e5\n" +
	"3envoy.config.filter.http.ext_authz.v2.CheckSettingsB\xb2\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
