...
const file_envoy_extensions_filters_http_header_mutation_v3_header_mutation_proto_rawDesc = "" +
	"\n" +
	"Fenvoy/extensions/filters/http/header_mutation/v3/header_mutation.proto\x120envoy.extensions.filters.http.header_mutation.v3\x1a:envoy/config/common/mutation_rules/v3/mutation_rules.proto\x1a\x1fenvoy/config/core/v3/base.proto\x1a\x1dudpa/annotations/status.proto\"\xb9\x02\n" +
	"\tMutations\x12b\n" +
	...
	"\x12response_mutations\x18\x02 \x03(\v25.envoy.config.common.mutation_rules.v3.HeaderMutationR\x11responseMutations\"s\n" +
