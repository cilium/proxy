...
const file_envoy_extensions_filters_http_thrift_to_metadata_v3_thrift_to_metadata_proto_rawDesc = "" +
	...
	"\x05child\x18\x03 \x01(\v2B.envoy.extensions.filters.http.thrift_to_metadata.v3.FieldSelectorR\x05child:\b\xd2Ƥ\xe1\x06\x02\b\x01\"\xbc\x03\n" +
	"\x04Rule\x12P\n" +
	"\x05field\x18\x01 \x01(\x0e2:.envoy.extensions.filters.http.thrift_to_metadata.v3.FieldR\x05field\x12s\n" +
	"\x0efield_selector\x18\x02 \x01(\v2B.envoy.extensions.filters.http.thrift_to_metadata.v3.FieldSelectorB\b\xd2Ƥ\xe1\x06\x02\b\x01R\rfieldSelector\x12)\n" +
	"\vmethod_name\x18\x03 \x01(\tB\b\xd2Ƥ\xe1\x06\x02\b\x01R\n" +
	"methodName\x12`\n" +
	"\n" +
