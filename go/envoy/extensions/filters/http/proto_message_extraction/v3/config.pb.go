...
const file_envoy_extensions_filters_http_proto_message_extraction_v3_config_proto_rawDesc = "" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12r\n" +
	"\x05value\x18\x02 \x01(\x0e2\\.envoy.extensions.filters.http.proto_message_extraction.v3.MethodExtraction.ExtractDirectiveR\x05value:\x028\x01\"U\n" +
	"\x10ExtractDirective\x12 \n" +
	"\x1cExtractDirective_UNSPECIFIED\x10\x00\x12\v\n" +
	"\aEXTRACT\x10\x01\x12\x12\n" +
	"\x0eEXTRACT_REDACT\x10\x02B\xe5\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\xd2Ƥ\xe1\x06\x02\b\x01\n" +
