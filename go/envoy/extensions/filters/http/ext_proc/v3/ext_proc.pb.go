...
const file_envoy_extensions_filters_http_ext_proc_v3_ext_proc_proto_rawDesc = "" +
	...
	"\x16allowed_override_modes\x18\x16 \x03(\v29.envoy.extensions.filters.http.ext_proc.v3.ProcessingModeR\x14allowedOverrideModes\x12j\n" +
	"\x16on_processing_response\x18\x17 \x01(\v2*.envoy.config.core.v3.TypedExtensionConfigB\b\xd2Ƥ\xe1\x06\x02\b\x01R\x14onProcessingResponse\"6\n" +
	...
	"\boverride\x12\x03\xf8B\x01\"\xf9\x03\n" +
	"\x10ExtProcOverrides\x12b\n" +
	"\x0fprocessing_mode\x18\x01 \x01(\v29.envoy.extensions.filters.http.ext_proc.v3.ProcessingModeR\x0eprocessingMode\x12\x1d\n" +
	"\n" +
	"async_mode\x18\x02 \x01(\bR\tasyncMode\x12-\n" +
	...
	"\x15grpc_initial_metadata\x18\a \x03(\v2!.envoy.config.core.v3.HeaderValueR\x13grpcInitialMetadataB\xae\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
