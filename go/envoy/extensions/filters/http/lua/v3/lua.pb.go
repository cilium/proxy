...
const file_envoy_extensions_filters_http_lua_v3_lua_proto_rawDesc = "" +
	"\n" +
	".envoy/extensions/filters/http/lua/v3/lua.proto\x12$envoy.extensions.filters.http.lua.v3\x1a\x1fenvoy/config/core/v3/base.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a#envoy/annotations/deprecation.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"\xdb\x03\n" +
	"\x03Lua\x12,\n" +
	...
	"#envoy.config.filter.http.lua.v2.Lua\"\xa9\x01\n" +
	"\vLuaPerRoute\x12%\n" +
	...
	"sourceCodeB\x0f\n" +
	"\boverride\x12\x03\xf8B\x01B\x9b\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
