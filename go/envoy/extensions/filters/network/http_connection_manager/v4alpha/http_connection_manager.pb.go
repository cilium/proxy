...
var file_envoy_extensions_filters_network_http_connection_manager_v4alpha_http_connection_manager_proto_rawDesc = []byte{
	...
	0x2e, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x64, 0x52, 0x64, 0x73, 0x22, 0xb5, 0x02, 0x0a, 0x0a, 0x48,
	...
	0x67, 0x12, 0x5d, 0x0a, 0x10, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x64, 0x69, 0x73, 0x63,
	0x6f, 0x76, 0x65, 0x72, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x65, 0x6e,
...
var file_envoy_extensions_filters_network_http_connection_manager_v4alpha_http_connection_manager_proto_goTypes = []interface{}{
	...
	(*v3.ResourceLocator)(nil),                                                          // 33: udpa.core.v1.ResourceLocator
...
var file_envoy_extensions_filters_network_http_connection_manager_v4alpha_http_connection_manager_proto_depIdxs = []int32{
	...
	33, // 33: envoy.extensions.filters.network.http_connection_manager.v4alpha.Rds.rds_resource_locator:type_name -> udpa.core.v1.ResourceLocator
	34, // 34: envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRouteConfigurationsList.scoped_route_configurations:type_name -> envoy.config.route.v4alpha.ScopedRouteConfiguration
	...
	32, // 36: envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRoutes.rds_config_source:type_name -> envoy.config.core.v4alpha.ConfigSource
	...
	32, // 39: envoy.extensions.filters.network.http_connection_manager.v4alpha.ScopedRds.scoped_rds_config_source:type_name -> envoy.config.core.v4alpha.ConfigSource
	35, // 40: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpFilter.typed_config:type_name -> google.protobuf.Any
	36, // 41: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpFilter.config_discovery:type_name -> envoy.config.core.v4alpha.ExtensionConfigSource
	35, // 42: envoy.extensions.filters.network.http_connection_manager.v4alpha.RequestIDExtension.typed_config:type_name -> google.protobuf.Any
	...
	26, // 46: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.Tracing.max_path_tag_length:type_name -> google.protobuf.UInt32Value
	...
	22, // 49: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.SetCurrentClientCertDetails.subject:type_name -> google.protobuf.BoolValue
	...
	22, // 51: envoy.extensions.filters.network.http_connection_manager.v4alpha.HttpConnectionManager.UpgradeConfig.enabled:type_name -> google.protobuf.BoolValue
