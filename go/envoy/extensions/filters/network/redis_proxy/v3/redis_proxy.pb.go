...
const file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_rawDesc = "" +
	...
	"5envoy.config.filter.network.redis_proxy.v2.RedisProxyJ\x04\b\x02\x10\x03R\acluster\"\xfc\x01\n" +
	...
	"\rauth_username\x18\x02 \x01(\v2 .envoy.config.core.v3.DataSourceB\x06\xb8\xb7\x8b\xa4\x02\x01R\fauthUsername:F\x9aň\x1eA\n" +
	"?envoy.config.filter.network.redis_proxy.v2.RedisProtocolOptions\"\x97\x01\n" +
