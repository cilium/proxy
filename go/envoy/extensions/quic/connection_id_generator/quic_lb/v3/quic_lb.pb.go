...
const file_envoy_extensions_quic_connection_id_generator_quic_lb_v3_quic_lb_proto_rawDesc = "" +
	"\n" +
	"Fenvoy/extensions/quic/connection_id_generator/quic_lb/v3/quic_lb.proto\x128envoy.extensions.quic.connection_id_generator.quic_lb.v3\x1a\x1fenvoy/config/core/v3/base.proto\x1a6envoy/extensions/transport_sockets/tls/v3/secret.proto\x1a\x1fxds/annotations/v3/status.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\x9a\x03\n" +
	"\x06Config\x12E\n" +
	"\x1funsafe_unencrypted_testing_mode\x18\x01 \x01(\bR\x1cunsafeUnencryptedTestingMode\x12G\n" +
	"\tserver_id\x18\x02 \x01(\v2 .envoy.config.core.v3.DataSourceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\bserverId\x12B\n" +
	...
	"\x15encryption_parameters\x18\x05 \x01(\v2:.envoy.extensions.transport_sockets.tls.v3.SdsSecretConfigB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x14encryptionParameters:\b\xd2Ƥ\xe1\x06\x02\b\x01B\xca\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
