...
const file_envoy_extensions_wasm_v3_wasm_proto_rawDesc = "" +
	"\n" +
	"#envoy/extensions/wasm/v3/wasm.proto\x12\x18envoy.extensions.wasm.v3\x1a\"envoy/config/core/v3/backoff.proto\x1a\x1fenvoy/config/core/v3/base.proto\x1a\x19google/protobuf/any.proto\x1a#envoy/annotations/deprecation.proto\x1a\x1dudpa/annotations/status.proto\"O\n" +
	"\fReloadConfig\x12?\n" +
	...
	"\x1dcapability_restriction_config\x18\x06 \x01(\v25.envoy.extensions.wasm.v3.CapabilityRestrictionConfigR\x1bcapabilityRestrictionConfigB\x04\n" +
	"\x02vm\"k\n" +
	"\vWasmService\x12>\n" +
