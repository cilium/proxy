...
const file_envoy_extensions_clusters_aggregate_v3_cluster_proto_rawDesc = "" +
	"\n" +
	"4envoy/extensions/clusters/aggregate/v3/cluster.proto\x12&envoy.extensions.clusters.aggregate.v3\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"r\n" +
	"\rClusterConfig\x12$\n" +
	"\bclusters\x18\x01 \x03(\tB\b\xfaB\x05\x92\x01\x02\b\x01R\bclusters:;\x9aň\x1e6\n" +
	"4envoy.config.cluster.aggregate.v2alpha.ClusterConfigB\xa9\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
