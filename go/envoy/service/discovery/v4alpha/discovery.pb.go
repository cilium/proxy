...
type DeltaDiscoveryRequest struct {
	...
	// [#not-implemented-hide:]
	UdpaResourcesSubscribe []*v3.ResourceLocator `protobuf:"bytes,8,rep,name=udpa_resources_subscribe,json=udpaResourcesSubscribe,proto3" json:"udpa_resources_subscribe,omitempty"`
	...
	// [#not-implemented-hide:]
	UdpaResourcesUnsubscribe []*v3.ResourceLocator `protobuf:"bytes,9,rep,name=udpa_resources_unsubscribe,json=udpaResourcesUnsubscribe,proto3" json:"udpa_resources_unsubscribe,omitempty"`
...
func (x *DeltaDiscoveryRequest) GetUdpaResourcesSubscribe() []*v3.ResourceLocator {
	if x != nil {
...
func (x *DeltaDiscoveryRequest) GetUdpaResourcesUnsubscribe() []*v3.ResourceLocator {
	if x != nil {
...
func (x *Resource) GetUdpaResourceName() *v3.ResourceName {
...
type Resource_UdpaResourceName struct {
	...
	UdpaResourceName *v3.ResourceName `protobuf:"bytes,5,opt,name=udpa_resource_name,json=udpaResourceName,proto3,oneof"`
}
...
var file_envoy_service_discovery_v4alpha_discovery_proto_goTypes = []interface{}{
	...
	(*v3.ResourceLocator)(nil),     // 10: udpa.core.v1.ResourceLocator
	(*v3.ResourceName)(nil),        // 11: udpa.core.v1.ResourceName
}
