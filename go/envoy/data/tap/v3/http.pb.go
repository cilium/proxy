...
const file_envoy_data_tap_v3_http_proto_rawDesc = "" +
	"\n" +
	"\x1cenvoy/data/tap/v3/http.proto\x12\x11envoy.data.tap.v3\x1a\x1fenvoy/config/core/v3/base.proto\x1a\x1eenvoy/data/tap/v3/common.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\"\xe8\x04\n" +
	...
	"\x15downstream_connection\x18\x03 \x01(\v2\x1d.envoy.data.tap.v3.ConnectionR\x14downstreamConnection\x1a\xbb\x02\n" +
	"\aMessage\x12;\n" +
