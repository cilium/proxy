...
type BpfMetadata struct {
	...
	ConfigSource  *v3.ConfigSource `protobuf:"bytes,16,opt,name=config_source,json=configSource,proto3" json:"config_source,omitempty"`
...
func (x *BpfMetadata) GetConfigSource() *v3.ConfigSource {
	if x != nil {
...
var file_cilium_api_bpf_metadata_proto_depIdxs = []int32{
	...
	2, // 3: cilium.BpfMetadata.config_source:type_name -> envoy.config.core.v3.ConfigSource
