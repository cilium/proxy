...
http_archive(
    ...
    patches = [
        ...
        "@//patches:0007-watcher-Assert-fd-is-valid-before-createFileEvent.patch",
        "@//patches:0008-RequestIDExtension-Make-usable-for-upstream-filters.patch",
        "@//patches:0009-upstream-Initialize-upstream-network-filters.patch",
    ],
    sha256 = ENVOY_SHA256,
